...
// Tasks icon
function SidebarTasksIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
// Isolated Tasks Button - full-width navigation link
const TasksButton = memo(function TasksButton() {
  const tasksEnabled = useAtomValue(betaTasksEnabledAtom)
  ...
  const isActive = desktopView === "tasks"
  ...
  return (
    ...
    >
      <SidebarTasksIcon className="h-4 w-4" />

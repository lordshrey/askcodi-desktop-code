...
2. Create the file .askcodi/worktree.json with setup commands
...
Example output for .askcodi/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .askcodi/worktree.json with the appropriate setup commands.`,
}

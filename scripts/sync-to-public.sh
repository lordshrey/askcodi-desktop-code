...
# Sync desktop app to public askcodi repository
...
PUBLIC_REPO="git@github.com:AskCodi/askcodi.git"
PUBLIC_REPO_HTTPS="https://github.com/AskCodi/askcodi"
PRIVATE_REPO="AskCodi/askcodi-desktop-code"
TEMP_DIR="/tmp/askcodi-sync-$$"
...
if [ -z "$RELEASE_NOTES" ]; then
    ...
    echo "   gh release create $TAG --title \"AskCodi $TAG\" --notes \"...\""
    echo ""

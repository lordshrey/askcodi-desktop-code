...
This is the open-source version of AskCodi. Some features require the hosted backend at askcodi.com:

| Feature | Open Source | Hosted (askcodi.com) |
|---------|-------------|-------------------|
